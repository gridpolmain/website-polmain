      ...
      <div class="container" style="border: none; margin-top: 0">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="<?= base_url();?>index.php/welcome/kerjasama" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff;">Pendaftaran</a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
